...
db_config = {
    ...
    'dbname': os.getenv('DB_NAME'),  # psycopg3 sử dụng 'dbname' thay vì 'database'
    'user': os.getenv('DB_USER'),
    'password': os.getenv('DB_PASSWORD'),
    'port': int(os.getenv('DB_PORT', '5432')),  # Chuyển đổi port thành int
    'sslmode': 'prefer'
}
...
app = FastAPI(
    title="FitBridge Chatbot AI",
    description="Chatbot tìm kiếm phòng gym thông minh sử dụng Gemini AI và PostgreSQL",
    version="2.0.0"
)
